...
@Component({
  selector: 'app-sessional-landing',
  templateUrl: './sessional-landing.component.html',
  styleUrls: ['./sessional-landing.component.scss']
})
export class SessionalLandingComponent implements OnInit {
