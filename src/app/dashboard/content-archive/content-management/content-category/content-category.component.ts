...
import { ContentCategoryFormComponent } from './content-category-form/content-category-form.component';
...
export class ContentCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.getEducationLevelDropdown();
  ...
  addData(data: any, dialogRef: any) {
    this.api.post('class/content-category', data).subscribe(
      (response) => {
        this.reloadTable();
  ...
  editData(data: any, id: number, dialogRef: any) {
    this.api.update(`class/content-category/${id}`, data).subscribe(
      (response) => {
        this.reloadTable();
        this.showBackendMessage(response.response);
        this.loaderService.setLoaderStatus(false);
  ...
  deleteInventoryCategory(id: number, dialogRef: any) {
    this.api.delete('class/content-category/', id).subscribe(
      (response) => {
        this.reloadTable();
