...
export class DesignationComponent implements OnInit {
  ...
  tableStructure: any = {
    ...
    banned: ['Sl No', 'Title', 'Institute', 'Order', 'Status', 'Actions'],
  };
  tableButtons: any[] = [
    {
      tooltip: 'Edit',
  ...
  addData(data: any, dialogRef: any) {
    this.api.post('settings/designation', data).subscribe(
      (response) => {
        this.reloadTable();
  ...
  editData(data: any, id: number, dialogRef: any) {
    this.api.update(`settings/designation/${id}`, data).subscribe(
      (response) => {
        this.reloadTable();
        this.showBackendMessage(response.response);
        this.loaderService.setLoaderStatus(false);
  ...
  deleteInventoryCategory(id: number, dialogRef: any) {
    this.api.delete('settings/designation/', id).subscribe(
      (response) => {
        this.reloadTable();
