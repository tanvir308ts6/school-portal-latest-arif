...
import { ReligionFormComponent } from './religion-form/religion-form.component';
...
export class ReligionComponent implements OnInit {
  ...
  actionForAdd() {
    const dialogRef = this.dialog.open(ReligionFormComponent, {
  ...
  addData(data: any, dialogRef: any) {
    this.api.post('settings/religion', data).subscribe(
      (response) => {
        this.reloadTable();
  ...
  editData(data: any, id: number, dialogRef: any) {
    this.api.update(`settings/religion/${id}`, data).subscribe(
      (response) => {
        this.reloadTable();
        this.showBackendMessage(response.response);
        this.loaderService.setLoaderStatus(false);
  ...
  deleteInventoryCategory(id: number, dialogRef: any) {
    this.api.delete('settings/religion/', id).subscribe(
      (response) => {
        this.reloadTable();
