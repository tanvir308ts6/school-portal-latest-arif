...
export class StorageService {
  ...
  public getOthersData(key_name: any): any {
    return localStorage ? JSON.parse(<string>localStorage.getItem(key_name)) : '';
  }

  public setFilterData(data: { [x: string]: any; }): void {
  ...
  public getFilterData(): any {
    return localStorage ? JSON.parse(<string>localStorage.getItem("filterData")) : '';
  }
